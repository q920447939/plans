        ...
        function chart6() {
            var errorBar = {
                enter: function(self, storage, className, data, callbacks) {
                    ...
                    container = self._g.selectAll('.errorLine' + className).data(eData,
                        function(d) {
                            return d.className;
                        });
                    ...
                    container.enter().insert('g', insertionPoint).attr('class',
                        function(d, i) {
        ...
        function chart_select() {
            ...
            $("#placeholder").bind("plotselected",
                function(event, ranges) {
                    ...
                    // do the zooming
                    plot = $.plot("#placeholder", getData(ranges.xaxis.from, ranges.xaxis.to), $.extend(true, {},
                        options, {
                            xaxis: {
